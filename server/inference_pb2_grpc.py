...
class InferenceServerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GenerateAudio = channel.unary_unary(
                '/InferenceServer/GenerateAudio',
                request_serializer=inference__pb2.InferenceRequest.SerializeToString,
                response_deserializer=inference__pb2.AudioResponse.FromString,
                _registered_method=True)
        self.GenerateImage = channel.unary_unary(
                '/InferenceServer/GenerateImage',
...
def add_InferenceServerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GenerateAudio': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=inference__pb2.AudioResponse.SerializeToString,
            ),
...
class InferenceServer(object):
    ...
    def GenerateAudio(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            inference__pb2.AudioResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
